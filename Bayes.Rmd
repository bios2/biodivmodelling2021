...
In general about a third of petrels survive.  Use grid search to find the posterior distribution of $p$, the probability that an egg successfully hatches. 
---
# Steps
...
> it is embarassing do to an elaborate numberical procedure to obtain results that can be obtained on a napkin -- Hobbs and Hooten
...
(in other words, if the ratio is better always take it. If the ratio is less than 1, there's a chance we'll take it anyway)
